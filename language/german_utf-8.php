<?php
/**
*   Default German Language file for the Banner plugin, addressing the user as "Du"
*
...
'ok_to_delete'  => 'Möchtest Du diesen Eintrag wirklich löschen?',
...
'access_denied_msg' => 'Leider hast Du keinen Zugriff auf dies Seite. Bitte beachten Sie, dass alle nicht autorisierten Zugriffe protokolliert werden.',
...
'validate_instr' => '<p> Um alle Banner zu überprüfen, klicke bitte auf &quot;Jetzt überprüfen&quot;. Dies kann, je nach Anzahl der Banner, einige Zeit in Anspruch nehmen.</p>',
'banner_mgr'    => 'Banner-Verwaltung',
'banner_instr_list' => 'Um ein Banner zu bearbeiten oder zu löschen, klicke unten auf das Bearbeitungssymbol. Um ein neues Banner zu erstellen, klicke oben auf &quot;Neues Banner&quot;.',
'banner_instr_validate' => 'Klicke auf die &quot;Jetzt überprüfen&quot; Schaltfläche, um die HTTP-Antwort der Banner-Links zu überprüfen.',
'enabled'       => 'Aktiviert',
...
'hlp_cat_type' => 'Der Typ der Kategorie wird verwendet, um die Anzeigenplatzierung in Vorlagen, Blöcken und Inhalten zu bestimmen. Wenn beispielsweise eine Kategorie der Banner im Hauptartikel platzieren werden soll, benenne den &quot;Typ&quot; mit &quot;hauptartikel&quot;. Füge dann die Variable &quot;&lcub;banner_hauptartikel&rcub;&quot; in ../layout_dir/featuredstorytext.thtml ein. Diese Variable wird nun durch die Banner dieser Kategorie ersetzt.',
...
$PLG_banner_MESSAGE1 = "Vielen dank für Deine Einsendung. Die Mitarbeiter von {$_CONF['site_name']} werden Deine<a href={$_CONF['site_url']}/banner/index.php>Banner</a>-Einsendung so schnell wie möglich überprüfen.";
$PLG_banner_MESSAGE2 = 'Dein Banner wurde erfolgreich gespeichert.';
$PLG_banner_MESSAGE3 = 'Das Banner wurde erfolgreich gelöscht.';
$PLG_banner_MESSAGE4 = "{$_CONF['site_name']} bedankt sich für Deine Banner-Einsendung.  Du findest Deine Banner in der <a href={$_CONF['site_url']}/banner/index.php>Banner</a>-Verwaltung.";
$PLG_banner_MESSAGE5 = 'Du hast nicht genügend Rechte um diese Kategorie anzuzeigen.';
$PLG_banner_MESSAGE6 = 'Du hast nicht genügend Rechte um diese Kategorie zu bearbeiten.';
$PLG_banner_MESSAGE7 = 'Bitte gib einen Kategorie-Namen und eine Beschreibung an.';

$PLG_banner_MESSAGE10 = 'Deine Kategorie wurde erfolgreich gespeichert.';
...
$PLG_banner_MESSAGE12 = 'Du versuchst aus einer übergeordnete Kategorie einen Eintrag seiner eigenen Unterkategorie zu machen. Dies würde eine verwaiste Kategorie erzeugen. Bitte verschiebe zuerst die untergeordneten Kategorien auf eine höhere Ebene.';
$PLG_banner_MESSAGE13 = 'Die Kategorie wurde erfolgreich gelöscht.';
$PLG_banner_MESSAGE14 = 'Die Kategorie enthält Banner oder Unterkategorien. Bitte entferne diese zuerst.';
$PLG_banner_MESSAGE15 = 'Du hast nicht genügend Rechte um diese Kategorie zu löschen.';
...
$LANG_BANNER_ADMIN = array(
    ...
    53 => 'Banner Banner',
    55 => 'Achtung: Du kannst keine Kategorie löschen, die andere Kategorien oder Banner enthalten. Um Kategorien löschen zu können musst Du deren Inhalt in eine andere Kategorie verschieben.',
    56 => 'Kategorie-Editor',
