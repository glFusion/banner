...
'html_status_na' => 'HTTP Response is not checked for HTML or script banners',
...
'hlp_remote_img' => 'Enter the URL where visitors will be redirected after clicking on an ad. This is required for images that are hosted locally or remotely, but not for HTML or Javascript-based ads since those will contain the url themselves.',
'hlp_adcode' => 'Enter the complete HTML or Javascript ad code to be used for this banner.',
...
'hlp_cat_maxwidth' => 'Enter the maximum allowed width for images in this category. If left blank, the global configuration item will prevail.',
'hlp_cat_maxheight' => 'Enter the maximum allowed height for images in this category. If left blank, the global configuration item will prevail.',
