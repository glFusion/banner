<?php
/**
 * Class to read and manipulate Banner configuration values.
 *
...
final class Config
{
    ...
    /**
     * Get the Banner configuration object.
    ...
    /**
     * Create an instance of the Banner configuration object.
     */
    private function __construct()
    {
        ...
        $this->properties['pi_display_name'] = 'Banners';
        ...
        $this->properties['img_dir'] = $_CONF['path'] . 'data/' . self::PI_NAME . '/banners/';
        $this->properties['public_dir'] = $_CONF['path_html'] . self::PI_NAME . '/images/banners/';
        $this->properties['img_url'] = $this->properties['url'] . '/images/banners';
